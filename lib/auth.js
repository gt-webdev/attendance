...
exports.registerUser = function registerUser(attribs) {
  ...
  bcrypt.genSalt(function(err, salt) {
    ...
    if (!re.emailre.test(attribs.userParams.email.toLowerCase()) ||
        !re.gtidre.test(attribs.userParams.gt_id) ||
        !re.passwordre.test(attribs.userParams.password) ||
        !re.standardre.test(attribs.login.toLowerCase())){
...
exports.preEveryauthMiddlewareHack = function() {
  return function (req, res, next) {
    var sess = req.session, k, auth = sess.auth,
